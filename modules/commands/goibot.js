...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "bot lon")) {
    return api.sendMessage("Tao là bot đéo có lồ/n hay cặ/c gì nhé 😠", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "địt") || (event.body.toLowerCase() == "dit")) {
    return api.sendMessage("Đị/t cc thích đ/ụ ko :)", threadID);
  };

  if ((event.body.toLowerCase() == "địt cc") || (event.body.toLowerCase() == "dit cc")) {
    return api.sendMessage("À mày thích đị/t à cởi quần ra đ/ụ lẹ nào :)", threadID);
  };

  if ((event.body.toLowerCase() == "thuận") || (event.body.toLowerCase() == "thuận")) {
  ...
  if ((event.body.toLowerCase() == "a Thuận") || (event.body.toLowerCase() == "a Thuận")) {
    return api.sendMessage("Anh ấy tuy ko đẹp trai hay giỏi gì nhưng được cái hài hước và luôn mong đạt được mục tiêu anh ấy muốn <3 <3 ", threadID);
  };

  if ((event.body.toLowerCase() == "thựng") || (event.body.toLowerCase() == "thựng")) {
    return api.sendMessage("Anh ấy tuy ko đẹp trai hay giỏi gì nhưng được cái hài hước và luôn mong đạt được mục tiêu anh ấy muốn <3 <3 ", threadID);
  };

  if ((event.body.toLowerCase() == "@Anh Thì Ben 10 Em Thì Ben Ai") || (event.body.toLowerCase() == "@Anh Thì Ben 10 Em Thì Ben Ai")) {
    return api.sendMessage("Ai kêu chủ tao đấy, mà làm ơn đừng tag anh ấy mà hãy liên hệ qua Fb: https://www.facebook.com/61573829113045", threadID);
  };
 ...
 if ((event.body.toLowerCase() == "bsvv nha mn") || (event.body.toLowerCase() == "bsvv nha mn")) {
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao Thuận có gì dùng lệnh ad hoặc adm để biết thêm chi tiết", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "cai lon") || (event.body.toLowerCase() == "cai lon")) {
    return api.sendMessage("️Mày bẩn vừa thôi con lồ/n :)))", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "bot có link fb của admin ko") || (event.body.toLowerCase() == "bot co link fb của admin ko")) {
    return api.sendMessage("Dĩ nhiên rồi có gì liên hệ anh ấy nha <3\nLink fb nè: https://www.facebook.com/61573829113045", threadID);
  };

  if ((event.body.toLowerCase() == "bot lỏ") ||  (event.body.toLowerCase() == "bot lam tho di")) {
    return api.sendMessage("mẹ mày cũng lỏ giống tao thôi :))", threadID);
  };

  if ((event.body.toLowerCase() == "bot ngu") ||  (event.body.toLowerCase() == "clmm bot lon")) {
    return api.sendMessage("xài bot ngu thì nín :))", threadID);
  };

  if ((event.body.toLowerCase() == "cc") ||  (event.body.toLowerCase() == "cc")) {
    return api.sendMessage("con cặ/c ba mày hay gì vậy em :))", threadID);
  };
